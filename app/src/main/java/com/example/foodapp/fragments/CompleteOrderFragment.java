...
import com.example.foodapp.activities.ReviewDetailActivity;
import com.example.foodapp.adapter.ListOrderAdapter;
import com.example.foodapp.base.BaseFragment;
import com.example.foodapp.databinding.FragmentCompleteOrderBinding;
...
public class CompleteOrderFragment extends BaseFragment  implements ListOrderAdapter.IListOrder {
...
//                                }
    ...
    public void viewReview(Order order) {
        Intent intent = new Intent(requireActivity(), ReviewDetailActivity.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable("order", order);
        intent.putExtras(bundle);
        startActivity(intent);
